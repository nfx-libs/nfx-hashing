...
namespace nfx::hashing::test
{
    ...
    TEST( Hashing64Bit, Constexpr64 )
    {
        ...
        constexpr uint64_t compileTimeCombine64 =
            combine<uint64_t>( 0x123456789ABCDEF0ULL, 0xFEDCBA9876543210ULL, FNV_PRIME_64 );
        ...
        EXPECT_EQ(
            combine<uint64_t>( 0x123456789ABCDEF0ULL, 0xFEDCBA9876543210ULL, FNV_PRIME_64 ), compileTimeCombine64 );
    ...
    TEST( Hashing64Bit, DualCRC32Coverage )
    {
        ...
        std::vector<std::string> testStrings{ "test1", "test2", "test3", "test4", "test5",
