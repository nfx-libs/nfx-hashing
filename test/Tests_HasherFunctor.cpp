...
namespace nfx::hashing::test
{
    ...
    TEST( HasherFunctor, TupleHashingMixedTypes )
    {
        ...
        std::tuple<std::string, int, std::pair<double, float>> complex1{ "key", 123, { 3.14, 2.71f } };
        std::tuple<std::string, int, std::pair<double, float>> complex2{ "key", 123, { 3.14, 2.71f } };
        std::tuple<std::string, int, std::pair<double, float>> complex3{ "key", 124, { 3.14, 2.71f } };
    ...
    TEST( HasherFunctor, DefaultHashTypeIs32Bit )
    {
        ...
        static_assert(
            std::is_same_v<decltype( defaultHasher( "test" ) ), uint32_t>, "Default hash type should be uint32_t" );
    }
