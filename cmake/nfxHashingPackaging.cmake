#==============================================================================
# nfx-hashing - Library packaging configuration (CPack)
#==============================================================================
...
if(NOT NFX_HASHING_PACKAGE_SOURCE
        AND NOT NFX_HASHING_PACKAGE_ARCHIVE
...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY   "Modern C++20 header-only hashing library with hardware acceleration")
...
set(CPACK_RESOURCE_FILE_LICENSE         ${NFX_HASHING_LICENSE_FILE})
...
set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY  "nfx-hashing")
...
if(NOT DEFINED CPACK_GENERATOR)
    ...
    # --- Archive packages ---
    if(NFX_HASHING_PACKAGE_ARCHIVE)
        if(UNIX AND NOT APPLE)
...
if("RPM" IN_LIST CPACK_GENERATOR AND UNIX AND NOT APPLE)
    ...
    set(CPACK_RPM_PACKAGE_LICENSE      ${NFX_HASHING_LICENSE})
