...
int main()
{
    ...
    std::cout << "hash<int>(42)                               = 0x" << std::hex << h7a << std::dec
              << " (default FNV_OFFSET_BASIS seed)\n";
    ...
    std::cout << "hash<string, uint32_t, 0x811C9DC5>(\"hello\") = 0x" << std::hex << h8a << std::dec
              << " (explicit FNV, same as default)\n";
