...
int main()
{
    ...
    //=====================================================================
    {
        ...
        std::cout << "FNV-1a Offset Basis (32-bit): 0x" << std::hex << std::setw( 8 ) << std::setfill( '0' )
                  << constants::FNV_OFFSET_BASIS_32 << "\n";
    ...
    //=====================================================================
    {
        ...
        for( uint32_t seed = 0; seed < 5; ++seed )
        {
            ...
            std::cout << "  Probe " << seed << " -> slot " << slot << " (0x" << std::hex << std::setw( 8 )
                      << std::setfill( '0' ) << slot << std::dec << ")\n";
        }
